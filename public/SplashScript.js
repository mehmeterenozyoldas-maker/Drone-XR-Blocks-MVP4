...
export class SplashScript extends xb.Script {
  constructor() {
    ...
    // Throttle depth mesh geometry updates to avoid headset freezing
  ...
  generateDecalAtIntersection(intersection) {
    ...
    if (now - this.lastDepthMeshUpdateTime > 1000) {
  ...
  update() {
    ...
    // Prune empty paintballs to prevent memory leak / performance degradation
